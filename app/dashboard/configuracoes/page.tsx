...
export default function ConfiguracoesPage() {
  ...
  return (
    <DashboardLayout>
      <div className="h-full flex flex-col pt-4 md:pt-6 overflow-hidden scrollbar-hide">
        {/* Header - Desktop */}
        <div className="hidden md:block px-6 pb-6 bg-transparent">
        ...
        {/* Header - Mobile */}
        <div className="md:hidden px-4 pb-4 bg-transparent">
        ...
        <div className="flex-1 overflow-auto px-4 md:px-6 scrollbar-hide">
