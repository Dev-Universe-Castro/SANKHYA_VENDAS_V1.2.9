...
export async function POST(request: NextRequest) {
    try {
        ...
        if (action === 'checkin') {
          ...
          INSERT INTO AD_VISITAS (CODVISITA, ID_EMPRESA, CODROTA, CODPARC, CODVEND, DATA_VISITA, STATUS, DTCAD, HORA_CHECKIN, LATITUDE, LONGITUDE)
          VALUES (:finalCodVisita, :idEmpresa, :codRota, :codParc, :codVend, TRUNC(SYSDATE), 'CHECKIN', SYSDATE, TO_CHAR(SYSDATE, 'HH24:MI:SS'), :lat, :lng)
        `, {
                    finalCodVisita,
                    idEmpresa,
          ...
          UPDATE AD_VISITAS 
          SET STATUS = 'CHECKIN', 
              HORA_CHECKIN = TO_CHAR(SYSDATE, 'HH24:MI:SS'), 
              DTALTER = SYSDATE,
              LATITUDE = :lat,
              LONGITUDE = :lng
        ...
        SET STATUS = 'CONCLUIDA',
            HORA_CHECKOUT = TO_CHAR(SYSDATE, 'HH24:MI:SS'),
