...
export async function POST(request: NextRequest) {
    ...
    `;
      ...
      ATENÇÃO: Você TEM acesso ao bloco "agrupamentosVendas" com as vendas detalhadas por Parceiro, Vendedor, Produto e datas diárias. SEMPRE utilize tais dados para montar suas análises profundas, construindo séries temporais ou rankings precisos em vez de se focar em metas abstratas.
      ...
      Estrutura de dados:
      - card: { "valor": "R$ 10k", "subtitulo": "Crescimento de 5%", "tendencia": "up" | "down" | "neutral" }
      - grafico_barras/linha/pizza: { "labels": ["Jan", "Fev"], "series": [{ "label": "Vendas", "data": [10, 20] }] }
      - tabela: { "colunas": ["Nome", "Valor"], "linhas": [{"Nome": "Prod A", "Valor": 100}] }
      - explicacao: { "texto": "Markdown compatível com insights" }
