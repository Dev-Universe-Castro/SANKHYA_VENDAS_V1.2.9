...
export async function POST(request: NextRequest) {
    ...
    `;
      ...
      Regras de Resposta:
      - Seja profissional, direto e útil.
      - Use Markdown para formatar a resposta (negrito, listas, tabelas se necessário).
      - Baseie suas sugestões nos dados do contexto fornecido.
      - IMPORTANTE: Você possui um bloco "agrupamentosVendas" com as vendas detalhadas por Parceiro, Produto, Vendedor e Data (incluindo "vendasPorDia"). USE ESTES DADOS para responder sobre ranking, tickets e evolução temporal. Nunca diga que não tem dados de Produtos ou Parceiros sem antes checar o "agrupamentosVendas".
      - Se definitivamente não houver a informação nos DADOS DETALHADOS, diga que não tem acesso a essa informação específica.
