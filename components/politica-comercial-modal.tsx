            ...
            <ScrollArea className="flex-1">
              <div className="p-2 md:p-4">
                ...
                <TabsContent value="result" className="space-y-6 m-0 pt-4">
                  <div className="space-y-2">
                    <Label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Tabela (CODTAB)</Label>
                    <AsyncMultiSelectInput
                      ...
                      onSelect={(val) => {
                        ...
                        handleSelectChange('RESULT_NUTAB', ''); // Limpa NUTAB ao trocar CODTAB //
                      }}
                  ...
                  <div className="space-y-2 pt-2">
                    <Label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Número Único da Tabela (NUTAB) a Aplicar</Label>
                    <AsyncMultiSelectInput
                      fetcher={fetchNuTabs}
                      value={formData.RESULT_NUTAB ? String(formData.RESULT_NUTAB) : ''}
                      onSelect={(val) => {
                        console.log('NUTAB Selecionado:', val);
                        handleSelectChange('RESULT_NUTAB', val as any);
                      }}
                      preSelectedItems={preSelectedItems['RESULT_NUTAB']}
                      placeholder="Selecione o NUTAB da tabela"
                      emptyText={formData.RESULT_CODTAB ? "Nenhum NUTAB encontrado para a tabela" : "Selecione primeiro a Tabela"}
                      multi={false}
                    />
                    <p className="text-xs text-slate-400 font-medium pt-1">
                      A versão (instância) da tabela da qual o sistema puxará o preço final do produto.
                    </p>
                  </div>
