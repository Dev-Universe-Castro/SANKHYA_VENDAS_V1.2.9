          ...
          <Table className="w-full table-fixed md:table-auto">
            <TableHeader className="bg-slate-50/50">
              <TableRow className="border-b border-[#F2F2F2] hover:bg-transparent">
                <TableHead className="text-[10px] md:text-xs font-bold text-slate-500 uppercase tracking-wider h-11 w-auto md:w-auto">ID</TableHead>
                <TableHead className="text-[10px] md:text-xs font-bold text-slate-500 uppercase tracking-wider h-11 w-auto md:w-auto">Nome</TableHead>
                <TableHead className="text-[10px] md:text-xs font-bold text-slate-500 uppercase tracking-wider h-11 w-auto md:w-auto">Email</TableHead>
                <TableHead className="text-[10px] md:text-xs font-bold text-slate-500 uppercase tracking-wider h-11 w-auto md:w-auto">Função</TableHead>
                <TableHead className="text-[10px] md:text-xs font-bold text-slate-500 uppercase tracking-wider h-11 w-auto md:w-auto">Vendedor/Gerente</TableHead>
                <TableHead className="text-[10px] md:text-xs font-bold text-slate-500 uppercase tracking-wider h-11 w-auto md:w-auto">Status</TableHead>
                {isAdmin && (
                  <TableHead className="text-right text-[10px] md:text-xs font-bold text-slate-500 uppercase tracking-wider h-11 w-auto md:w-auto">Ações</TableHead>
                )}
              </TableRow>
            </TableHeader>
            <TableBody>
                          ...
                          {user.status === "pendente" ? (
                            <>
                              <Button
                                ...
                                className="bg-[#76BA1B] hover:bg-[#1E5128] text-white font-bold rounded-xl shadow-md h-9 px-3"
                              >
                              ...
                              <Button
                                ...
                                className="bg-red-500 hover:bg-red-600 text-white font-bold rounded-xl shadow-md h-9 px-3"
                              >
                            ...
                            <>
                              <Button
                                ...
                                className="bg-white hover:bg-slate-50 text-slate-700 font-bold border-[#F2F2F2] rounded-xl h-9"
                              >
                              ...
                              <Button
                                ...
                                className="bg-white hover:bg-slate-50 text-[#1E5128] font-bold border-[#F2F2F2] rounded-xl h-9"
                              >
                              ...
                              <Button
                                ...
                                className={cn(
                                  "bg-white hover:bg-slate-50 border-[#F2F2F2] font-bold rounded-xl h-9",
                                  isUserBlocked(user) ? "text-slate-500" : "text-red-500"
                                )}
                              >
                                {isUserBlocked(user) ? (
                                  <>
